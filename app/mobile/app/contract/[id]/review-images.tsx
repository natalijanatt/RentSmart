...
export default function ReviewImagesScreen() {
  ...
  const handleApprove = () => {
    Alert.alert(
      inspectionType === 'checkin' ? 'Approve check-in' : 'Approve check-out',
      `Are you sure? This will mark the ${inspectionType === 'checkin' ? 'check-in' : 'check-out'} as approved.`,
      [
      ...
      <Modal visible={rejectModalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Button label="Submit Rejection" onPress={handleRejectSubmit} fullWidth style={styles.actionButton} />
            <Button
              label="Cancel"
...
const styles = StyleSheet.create({
  ...
  charCount: { color: Colors.textSecondary, textAlign: 'right', marginBottom: Spacing.lg },
  lightboxOverlay: {
    flex: 1,
    backgroundColor: '#000',
